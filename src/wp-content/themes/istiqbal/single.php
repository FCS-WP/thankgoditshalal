 ...
 */
	...
	// Theme Options
	$istiqbal_single_comment = cs_get_option( 'single_comment_form' );
...
?>
<div class="wpo-blog-single-section section-padding <?php echo esc_attr( $istiqbal_content_padding .' '. $istiqbal_sidebar_class ); ?>" style="<?php echo esc_attr( $istiqbal_custom_padding ); ?>">

...
get_header();
	...
	// Theme Options
	$istiqbal_sidebar_position = cs_get_option( 'service_sidebar_position' );
	$istiqbal_single_comment = cs_get_option( 'service_comment_form' );
	...
	if ( $istiqbal_sidebar_position === 'sidebar-hide' ) {
		$istiqbal_layout_class = 'col-md-12 col col-xs-12';
		$istiqbal_sidebar_class = 'hide-sidebar';
	} elseif ( $istiqbal_sidebar_position === 'sidebar-left' ) {
		$istiqbal_layout_class = 'col col-lg-8 col-lg-push-4';
		$istiqbal_sidebar_class = 'left-sidebar';
	} else {
		$istiqbal_layout_class = 'col-lg-8';
		$istiqbal_sidebar_class = 'right-sidebar';
	} ?>
<div class="service-single-section section-padding <?php echo esc_attr( $istiqbal_content_padding .' '. $istiqbal_sidebar_class ); ?>" style="<?php echo esc_attr( $istiqbal_custom_padding ); ?>">
	<div class="container">
		<div class="row">

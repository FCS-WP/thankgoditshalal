/*
 * All Admin Related Scripts in this Istiqbal Theme
...
"use strict";
  ...
  /*---------------------------------------------------------------*/
   function istiqbal_gutenberg_toggle_metaboxes() {
  ...
  function istiqbal_toggle_metaboxes() {
  ...
  $(document).ready(function() {
      istiqbal_gutenberg_toggle_metaboxes();
      istiqbal_toggle_metaboxes();
    $('#post-formats-select input[type="radio"]').on('click', istiqbal_toggle_metaboxes);
  });

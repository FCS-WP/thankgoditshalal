<?php
/* Spacer */
function istiqbal_spacer_function($atts, $content = true) {
...
add_shortcode("istiqbal_spacer", "istiqbal_spacer_function");

/* Social Icons */
function istiqbal_socials_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "social_select" => '',
    "custom_class" => '',
    "section_title" => '',
  ...
  if ( $icon_color || $icon_size ) {
    ...
    $inline_style .= ( $icon_size ) ? 'font-size:'. istiqbal_core_check_px($icon_size) .';' : '';
    $inline_style .= '}';
  }
...
add_shortcode("istiqbal_socials", "istiqbal_socials_function");

/* Social Icon */
function istiqbal_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_link" => '',
      "social_icon" => '',
      "target_tab" => ''
...
add_shortcode("istiqbal_social", "istiqbal_social_function");



/* Simple Images */
function istiqbal_image_lists_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "custom_class" => '',
  ), $atts));
...
add_shortcode("istiqbal_image_lists", "istiqbal_image_lists_function");

/* Simple Image */
function istiqbal_image_list_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "get_image" => '',
    "link" => '',
    "open_tab" => ''
...
add_shortcode("istiqbal_image_list", "istiqbal_image_list_function");

/* Simple Underline Link */
function istiqbal_simple_link_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "link_style" => '',
    "link_icon" => '',
    "link_text" => '',
  ...
  if ( $text_color || $text_size ) {
    ...
    $inline_style .= ( $text_size ) ? 'font-size:'. istiqbal_core_check_px($text_size) .';' : '';
    $inline_style .= '}';
  }
  if ( $text_hover_color ) {
...
add_shortcode("istiqbal_simple_link", "istiqbal_simple_link_function");


/* Top bar info */
function istiqbal_widget_topbars_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("istiqbal_widget_topbars", "istiqbal_widget_topbars_functions");

/* Top bar info */
function istiqbal_widget_topbar_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info_icon" => '',
      "subtitle" => '',
      "title" => '',
...
add_shortcode("istiqbal_widget_topbar", "istiqbal_widget_topbar_function");


/*header Social */
function istiqbal_header_socials_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "custom_text" => ''
   ), $atts));
...
add_shortcode("istiqbal_header_socials", "istiqbal_header_socials_function");

/* Address Info */
function istiqbal_header_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "social_link" => '',
...
add_shortcode("istiqbal_header_social", "istiqbal_header_social_function");


/*header Middle Info */
function istiqbal_header_middle_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("istiqbal_header_middle_infos", "istiqbal_header_middle_infos_function");

/*header Middle Info  */
function istiqbal_header_middle_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "address_text" => '',
...
add_shortcode("istiqbal_header_middle_info", "istiqbal_header_middle_info_function");
/*header Middle Info End */

/* Address Infos */
function istiqbal_address_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("istiqbal_address_infos", "istiqbal_address_infos_function");

/* Address Info */
function istiqbal_address_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "address_style" => '',
      "info_icon" => '',
      "info_icon_color" => '',
...
add_shortcode("istiqbal_address_info", "istiqbal_address_info_function");

/* Useful Links */
function istiqbal_useful_links_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "column_width" => '',
      "custom_class" => ''
   ), $atts));
...
add_shortcode("istiqbal_useful_links", "istiqbal_useful_links_function");

/* Useful Link */
function istiqbal_useful_link_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "target_tab" => '',
      "title_link" => '',
      "link_title" => ''
...
add_shortcode("istiqbal_useful_link", "istiqbal_useful_link_function");

/* Footer Menus */
function istiqbal_footer_menus_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("istiqbal_footer_menus", "istiqbal_footer_menus_function");

/* Footer Menu */
function istiqbal_footer_menu_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "menu_title" => '',
      "menu_link" => '',
      "target_tab" => ''
...
add_shortcode("istiqbal_footer_menu", "istiqbal_footer_menu_function");

/* footer contact */
function istiqbal_footer_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("istiqbal_footer_contact_infos", "istiqbal_footer_contacts_functions");

/*  footer contact  */
function istiqbal_footer_contacts_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "icon" => '',
      "item_title" => '',
   ), $atts));
...
add_shortcode("istiqbal_footer_contact_info", "istiqbal_footer_contacts_function");


 /* footer Address */
function istiqbal_addresss_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("istiqbal_footer_address_item", "istiqbal_addresss_functions");


 /* footer Addresss */
function istiqbal_address_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "item" => '',
   ), $atts));
...
add_shortcode("istiqbal_footer_address_items", "istiqbal_address_functions");

/* Blockquote */
function istiqbal_blockquote_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "blockquote_style" => '',
    "text_size" => '',
    "custom_class" => '',
...
add_shortcode("istiqbal_blockquote", "istiqbal_blockquote_function");


/* Footer Logo Items */
function istiqbal_widget_footer_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "footer_logo" => '',
      "desc" => '',
...
add_shortcode("footer_infos", "istiqbal_widget_footer_infos_functions");


/* Footer Logo Item */
function istiqbal_widget_footer_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_link" => '',
   ), $atts));
...
add_shortcode("footer_info", "istiqbal_widget_footer_infos_function");


/* Contact Infos */
function istiqbal_widget_contact_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "heading_title" => ''
   ), $atts));
...
add_shortcode("istiqbal_widget_contact_infos", "istiqbal_widget_contact_infos_functions");


/* Widget Contact Info */
function istiqbal_widget_contact_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "number" => '',
...
add_shortcode("istiqbal_widget_contact_info", "istiqbal_widget_contact_infos_function");


/* Widget Contact Info */
function istiqbal_widget_testimonial_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "subtitle" => '',
...
add_shortcode("istiqbal_widget_testimonial", "istiqbal_widget_testimonial_function");


/* Service Contact Widgets */
function istiqbal_service_widget_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("istiqbal_service_widget_contacts", "istiqbal_service_widget_contacts_functions");

/* Service Contact Widget */
function istiqbal_service_widget_contact_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info" => '',
   ), $atts));
...
add_shortcode("istiqbal_service_widget_contact", "istiqbal_service_widget_contact_functions");

/* Download Widgets */
function istiqbal_download_widgets_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("istiqbal_download_widgets", "istiqbal_download_widgets_functions");

/* Download Widget */
function istiqbal_download_widget_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "download_icon" => '',
      "title" => '',
      "link" => '',
...
add_shortcode("istiqbal_download_widget", "istiqbal_download_widget_functions");

/* Current Year - Shortcode */
if( ! function_exists( 'istiqbal_current_year' ) ) {
  function istiqbal_current_year() {
    return date('Y');
  }
  add_shortcode( 'istiqbal_current_year', 'istiqbal_current_year' );
}

/* Get Home Page URL - Via Shortcode */
if( ! function_exists( 'istiqbal_home_url' ) ) {
  function istiqbal_home_url() {
    return esc_url( home_url( '/' ) );
  }
  add_shortcode( 'istiqbal_home_url', 'istiqbal_home_url' );
}


/* About Widget */
function istiqbal_widget_about_block_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "image_url" => '',
...
add_shortcode("istiqbal_about_widget", "istiqbal_widget_about_block_function");
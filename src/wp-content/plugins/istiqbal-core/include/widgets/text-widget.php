 ...
 */
class istiqbal_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      ISTIQBAL_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'istiqbal' ),
      array(
        'classname'   => 'text-widget',
        'description' => ISTIQBAL_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'istiqbal' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "istiqbal_text_widget" ); } );
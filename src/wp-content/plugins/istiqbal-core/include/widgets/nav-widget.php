...
class istiqbal_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-navigation-widget',
      ISTIQBAL_THEME_NAME_PLUGIN . esc_html__( ': Navigation', 'istiqbal' ),
      array(
        'classname'   => 'link-widget',
        'description' => ISTIQBAL_THEME_NAME_PLUGIN . esc_html__( ' widget that displays navigations list.', 'istiqbal' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'istiqbal' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'istiqbal' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'istiqbal' ),
    );
...
add_action( 'widgets_init', function() { register_widget( "istiqbal_navigation_widget" ); } );

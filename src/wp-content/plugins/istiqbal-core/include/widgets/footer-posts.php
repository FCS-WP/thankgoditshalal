 ...
 */
class istiqbal_footer_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-footer-blog',
      ISTIQBAL_THEME_NAME_PLUGIN . esc_html__( ': Footer Posts', 'istiqbal' ),
      array(
        'classname'   => 'footer-post-widget',
        'description' => ISTIQBAL_THEME_NAME_PLUGIN . esc_html__( ' widget that displays footer posts.', 'istiqbal' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Footer Posts', 'istiqbal' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
...
add_action( 'widgets_init', function() { register_widget( "istiqbal_footer_posts" ); } );
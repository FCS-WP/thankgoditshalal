...
$( window ).on( 'elementor/frontend/init', function() {
    ...
    //Slider
    elementorFrontend.hooks.addAction( 'frontend/element_ready/wpo-istiqbal_slider.default', function($scope, $){
      swiper_slide();
    } );
    ...
    //testimonial
    elementorFrontend.hooks.addAction( 'frontend/element_ready/wpo-istiqbal_testimonial.default', function($scope, $){
        testimonials_slider();
    } );

    //odometer
    elementorFrontend.hooks.addAction( 'frontend/element_ready/wpo-istiqbal_funfact.default', function($scope, $){
        odometer();
    } );

    //partners_slider
    elementorFrontend.hooks.addAction( 'frontend/element_ready/wpo-istiqbal_client.default', function($scope, $){
        partners_slider();
    } );

    //prayer_slide
    elementorFrontend.hooks.addAction( 'frontend/element_ready/wpo-istiqbal_gallery.default', function($scope, $){
        prayer_slide();
    } );

    //event_date
    elementorFrontend.hooks.addAction( 'frontend/element_ready/wpo-istiqbal_event.default', function($scope, $){
        event_date();
    } );

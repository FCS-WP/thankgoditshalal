<?php
/*
 * Elementor Istiqbal Button Widget
...
class Istiqbal_Button extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-istiqbal_button';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Button', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Button widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Button widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Button',
			[
				'label' => __( 'Button Options', 'istiqbal-core' ),
			]
		);
		$this->add_control(
			'btn_style',
			[
				'label' => esc_html__( 'Button Style', 'istiqbal-core' ),
				...
				'default' => 'style-one',
				'description' => esc_html__( 'Select your Button style.', 'istiqbal-core' ),
			]
		);
		$this->add_responsive_control(
			'section_alignment',
			[
				'label' => esc_html__( 'Alignment', 'istiqbal-core' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'istiqbal-core' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'istiqbal-core' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'istiqbal-core' ),
		...
		$this->start_controls_tabs( 'button_style' );
			...
			$this->add_control(
				'link_border_color',
				[
					'label' => esc_html__( 'Link Border Color', 'istiqbal-core' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
...
Plugin::instance()->widgets_manager->register( new Istiqbal_Button() );
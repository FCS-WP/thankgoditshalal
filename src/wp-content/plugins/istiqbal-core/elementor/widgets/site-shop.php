<?php
/*
 * Elementor Istiqbal Product Widget
...
class Istiqbal_Product extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-istiqbal_product';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Product', 'istiqbal-core' );
	}
  ...
  public function get_keywords() {
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Product widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Product widget controls.
    ...
    if ( $posts ) {
      ...
      $PostID[ __( 'No ID\'s found', 'istiqbal' ) ] = 0;
		...
		$this->add_control(
			'product_limit',
			[
				'label' => esc_html__( 'Product Limit', 'istiqbal-core' ),
...
Plugin::instance()->widgets_manager->register( new Istiqbal_Product() );
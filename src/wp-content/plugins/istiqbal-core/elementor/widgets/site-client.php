<?php
/*
 * Elementor Istiqbal Client Widget
...
class Site_Client extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Client', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Client widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Client widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_client',
			[
				'label' => esc_html__( 'Client Options', 'istiqbal-core' ),
			]
		);
		$this->add_control(
			'client_style',
			[
				'label' => esc_html__( 'Client Style', 'istiqbal-core' ),
				...
				'default' => 'style-one',
				'description' => esc_html__( 'Select your Client style.', 'istiqbal-core' ),
			]
		);
		$this->add_control(
			'section_title',
		...
		$this->add_control(
			'clientLogos_groups',
			[
				'label' => esc_html__( 'Client Logos', 'istiqbal-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'client_title' => esc_html__( 'Client', 'istiqbal-core' ),
					],

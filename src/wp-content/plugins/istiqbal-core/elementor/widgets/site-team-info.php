<?php
/*
 * Elementor istiqbal Team Info Widget
...
class Site_TeamInfo extends Widget_Base
{
	...
	{
		return esc_html__('Team Info', 'istiqbal-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_TeamInfo',
			[
				'label' => esc_html__('Team Info Options', 'istiqbal-core'),
			]
		);
		$this->add_control(
			'section_title',
		...
		$this->add_control(
			'team_image',
			[
				'label' => esc_html__('Team Image', 'istiqbal-core'),
		...
		$this->add_control(
			'certificate_gallery',
			[
				'label' => esc_html__('Add Images', 'istiqbal-core'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Team Info', 'istiqbal-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'single_team_title' => esc_html__('Team Info', 'istiqbal-core'),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Info', 'istiqbal-core'),

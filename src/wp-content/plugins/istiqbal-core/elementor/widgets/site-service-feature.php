<?php
/*
 * Elementor Istiqbal ServiceItem Widget
...
class Site_ServiceItem extends Widget_Base
{
	...
	{
		return 'wpo-istiqbal_serviceitem';
	}
	...
	{
		return esc_html__('Service Feature', 'istiqbal-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Istiqbal ServiceItem widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal ServiceItem widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_ServiceItem',
			[
				'label' => esc_html__('ServiceItem Options', 'istiqbal-core'),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Feature Icons', 'istiqbal-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'single_feature_title' => esc_html__('Feature', 'istiqbal-core'),
					],

...
class Istiqbal_Contactinfo extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-istiqbal_contactinfo';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Contact Info', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Contactinfo widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Contactinfo widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_contactinfo',
			[
				'label' => esc_html__( 'Contactinfo Options', 'istiqbal-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( '24/7 customer support.', 'istiqbal-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Contactinfo Icons', 'istiqbal-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'contactinfo_title' => esc_html__( 'Contactinfo', 'istiqbal-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Info Box', 'istiqbal-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon BG', 'istiqbal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	// Content
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Active', 'istiqbal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'active_bg_color',
			[
				'label' => esc_html__( 'Active Background', 'istiqbal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'active_border_color',
			[
				'label' => esc_html__( 'Active Border', 'istiqbal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'active_color',
			[
				'label' => esc_html__( 'Text Color', 'istiqbal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Istiqbal_Contactinfo() );
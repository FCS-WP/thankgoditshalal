<?php
/*
 * Elementor Istiqbal Contact Form 7 Widget
...
class Site_Contact_Form extends Widget_Base{
	...
	*/
	public function get_name(){
		return 'wpo-istiqbal_contact_form';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Contact Form', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Contact Form widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Contact Form widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Options', 'istiqbal-core' ),
			]
		);
		$this->add_control(
			'form_title',
			[
				...
				'label_block' => true,
				'default' => esc_html__( 'Default title', 'istiqbal-core' ),
				'placeholder' => esc_html__( 'Type your title here', 'istiqbal-core' ),
			]
		);	
		$this->add_control(
			'form_content',
			[
				...
				'label_block' => true,
				'default' => esc_html__( 'Default content', 'istiqbal-core' ),
		...
		$this->add_control(
			'form_id',
			[
				'label' => esc_html__( 'Select contact form', 'istiqbal-core' ),
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'istiqbal_content_typography',
		...
		$this->start_controls_section(
			'section_form_style',
			[
				'label' => esc_html__( 'Form', 'istiqbal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				'label' => __( 'Placeholder Text Color', 'istiqbal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'label_color',
			[
				'label' => __( 'Label Color', 'istiqbal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'text_color',
			[
				'label' => __( 'Text Color', 'istiqbal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [

<?php
/*
 * Elementor Istiqbal Tabs Widget
...
class Istiqbal_Tabs  extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-istiqbal_tabs';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Tabs ', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Tabs  widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Tabs  widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => esc_html__( 'Tabs  Options', 'istiqbal-core' ),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __( 'Active Tabs', 'istiqbal-core' ),
		...
		$this->add_control(
			'tabsItems_groups',
			[
				'label' => esc_html__( 'Tabs  Items', 'istiqbal-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tabs_title' => esc_html__( 'Tabs ', 'istiqbal-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tabs Title', 'istiqbal-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Background Color', 'istiqbal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tabs Content', 'istiqbal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
...
Plugin::instance()->widgets_manager->register( new Istiqbal_Tabs () );
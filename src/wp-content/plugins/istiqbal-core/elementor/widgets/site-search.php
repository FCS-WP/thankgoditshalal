<?php
/*
 * Elementor Istiqbal Search Widget
...
class Istiqbal_Search extends Widget_Base{
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Search widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Search widget controls.
...
Plugin::instance()->widgets_manager->register( new Istiqbal_Search() );
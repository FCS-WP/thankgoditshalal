<?php
/*
 * Elementor Istiqbal Video Widget
...
class Site_Video extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Video', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Video widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Video widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_video',
			[
				'label' => esc_html__( 'Video Options', 'istiqbal-core' ),
			]
		);
	...
	$this->add_control(
			'video_image',
			[
				'label' => esc_html__( 'Video Image', 'istiqbal-core' ),
		...
		$this->add_control(
			'video_link',
			[
				'label' => esc_html__( 'Video Link', 'istiqbal-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( '#', 'istiqbal-core' ),
				'placeholder' => esc_html__( 'Type video link here', 'istiqbal-core' ),
				'label_block' => true,
			]
		);
		...
		$this->start_controls_section(
			'section_video_style',
			[
				'label' => esc_html__( 'Video', 'istiqbal-core' ),

<?php
/*
 * Elementor Istiqbal Header Widget
...
class Site_Header extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Header', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Header widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Header widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Header',
			[
				'label' => esc_html__( 'Header Options', 'istiqbal-core' ),
			]
		);
		$this->add_control(
			'navigation_style',
			[
				...
				'default' => 'style-one',
				'description' => esc_html__( 'Select your navigation style.', 'istiqbal-core' ),
			]
		);
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label' => __( 'Menu', 'istiqbal' ),
					'type' => Controls_Manager::SELECT,
					'options' => $menus,
					'default' => array_keys( $menus )[0],
					'save_default' => true,
					'separator' => 'after',
					'description' => sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'istiqbal' ), admin_url( 'nav-menus.php' ) ),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __( 'There are no menus in your site.', 'istiqbal' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'istiqbal' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator' => 'after',
					'content_classes' => 'istiqbal-panel-alert istiqbal-panel-alert-info',
				]
			);
		}
		$this->add_control(
			'header_logo',
			[
				'label' => esc_html__( 'Logo Image', 'istiqbal-core' ),
		...
		$this->add_control(
			'header_search',
			[
				'label' => esc_html__( 'Search', 'istiqbal-core' ),
		...
		$this->add_control(
			'header_cart',
			[
				'label' => esc_html__( 'Cart', 'istiqbal-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'istiqbal-core' ),
				'label_off' => esc_html__( 'Hide', 'istiqbal-core' ),
				'return_value' => 'true',
		...
		$this->start_controls_section(
			'istiqbal_section_style_main-menu',
			[
				'label' => __( 'Main Menu', 'istiqbal' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Main Menu Height', 'istiqbal' ),
		...
		$this->start_controls_tab(
			'istiqbal_tab_menu_item_normal',
			[
				'label' => __( 'Normal', 'istiqbal' ),
			]
		);

		$this->add_control(
			'istiqbal_color_menu_bg_item',
			[
				'label' => __( 'Background Color', 'istiqbal' ),
		...
		$this->add_control(
			'istiqbal_color_menu_item',
			[
				'label' => __( 'Text Color', 'istiqbal' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Horizontal Padding', 'istiqbal' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Vertical Padding', 'istiqbal' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			...
			[
				'raw' => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'istiqbal' ),
				'type' => Controls_Manager::RAW_HTML,
				'content_classes' => 'istiqbal-descriptor',
			]
		);
		...
		$this->start_controls_section( 'style_toggle',
			[
				'label' => __( 'Toggle Button', 'istiqbal' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'description' => esc_html__( 'Button Color', 'istiqbal-core' ),
				'types' => [ 'gradient' ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Search & Cart', 'istiqbal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	*/
	protected function render() {
		...
		if ( $navigation_style == 'style-one' ) {
			...
			$nav_style = 'transparent-header wpo-site-header-s1';
			$logo_col = 'col-lg-2';
			$header_container = 'container-fluid';
			$header_right_col = 'col-lg-3';
		} else {
			$nav_style = 'wpo-site-header-s2';
			$logo_col = 'd-lg-none dl-block';
			$header_container = 'container';
			$header_right_col = 'col-lg-5';
		}
											    ...
											    <div class="mini-cart-content">
											      <button class="mini-cart-close"><i class="ti-close"></i></button>
											        <div class="mini-cart-title">
											            <p><?php echo esc_html__('Shopping Cart','istiqbal'); ?></p>
											        </div>

...
class Istiqbal_Team extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-istiqbal_team';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Team', 'istiqbal-core' );
	}
	...
	protected function register_controls(){
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Type sub title text here', 'istiqbal-core' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
		...
		$this->add_control(
			'teamItems_groups',
			[
				'label' => esc_html__( 'Team Items', 'istiqbal-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'team_title' => esc_html__( 'Team', 'istiqbal-core' ),
					],
...
Plugin::instance()->widgets_manager->register( new Istiqbal_Team() );
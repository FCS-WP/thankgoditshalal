<?php
/*
 * Elementor Istiqbal Navmenu Widget
...
class Istiqbal_Navmenu extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Nav Menu', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Navmenu widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Navmenu widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Navmenu',
			[
				'label' => esc_html__( 'Navmenu Options', 'istiqbal-core' ),
			]
		);
...
Plugin::instance()->widgets_manager->register( new Istiqbal_Navmenu() );
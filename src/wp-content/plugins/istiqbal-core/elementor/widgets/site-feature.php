<?php
/*
 * Elementor Istiqbal Feature Widget
...
class Site_Feature extends Widget_Base
{
	...
	{
		return esc_html__('Feature', 'istiqbal-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Feature widget depended on.
	...
	/**
	 * Register Istiqbal Feature widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_feature',
			[
				'label' => esc_html__('Feature Options', 'istiqbal-core'),
			]
		);
		$this->add_control(
			'feature_style',
			[
				'label' => esc_html__('Feature Style', 'istiqbal-core'),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__('Make Donation', 'istiqbal-core'),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__('Donate now to help those in need! Make a difference by taking action with your donation.', 'istiqbal-core'),
		...
		$repeater->add_control(
			'feature_link',
			[
				'label' => esc_html__('link', 'istiqbal-core'),
				'default' => esc_html__('#', 'istiqbal-core'),
				'placeholder' => esc_html__('Type your link here', 'istiqbal-core'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		$this->add_control(
			'featureItems_groups',
			[
				'label' => esc_html__('Feature', 'istiqbal-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'feature_title' => esc_html__('Feature', 'istiqbal-core'),
					],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .istiqbal-feature .features-wrap .feature-item, .wpo-service-section .service-item' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section(); // end: Section
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .istiqbal-feature .feature-item i:before' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => ['image'],
				'selector' => '{{WRAPPER}} .istiqbal-feature .features-wrap .feature-item-wrap .feature-item .icon',
				'fields_options' => [
					'background' => [
						'label' => esc_html__('Background', 'istiqbal-core'),
						'default' => 'gradient',
	...
	protected function render()
	{
		...
		<?php if ($feature_style == 'style-one') { ?>
			<div class="istiqbal-feature wpo-features-area">
			    <div class="container">
		...
		<?php } else { ?>
		<div class="istiqbal-feature wpo-service-section">
		    <div class="container">

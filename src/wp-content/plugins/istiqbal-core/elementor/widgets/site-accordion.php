<?php
/*
 * Elementor Istiqbal Accordion  Widget
...
class Istiqbal_Accordion  extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-istiqbal_accordion';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Accordion ', 'istiqbal-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Istiqbal Accordion  widget depended on.
	...
	*/
	...
	/**
	 * Register Istiqbal Accordion  widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_accordion',
			[
				'label' => esc_html__( 'Accordion  Options', 'istiqbal-core' ),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __( 'Active Accordion', 'istiqbal-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'istiqbal-core' ),
				'label_off' => __( 'Hide', 'istiqbal-core' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Accordion  Items', 'istiqbal-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'accordion_title' => esc_html__( 'Accordion ', 'istiqbal-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Accordion Content', 'istiqbal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				'label' => esc_html__( 'Typography', 'istiqbal-core' ),
				'name' => 'istiqbal_accordion_content_typography',
...
Plugin::instance()->widgets_manager->register( new Istiqbal_Accordion () );